...
def get_fallback_trends_by_quarter():
    """คืน fallback trends ตามไตรมาสปัจจุบัน"""
    now = datetime.now()
    month = now.month
    ...
    if month in [1, 2, 3]:
        quarter = "Q1"
        fallback = [
            "ธุรกิจร้านอาหาร", "ธุรกิจแฟรนไชส์กาแฟ", "ธุรกิจส่งอาหารเดลิเวอรี่",
            "บริการซ่อมมือถือ", "ธุรกิจขายของออนไลน์", "คลินิกความงาม",
            "ธุรกิจสตาร์ทอัพ", "ร้านเบเกอรี่", "ธุรกิจค้าส่ง", "บริการทำความสะอาด"
        ]
    elif month in [4, 5, 6]:
        quarter = "Q2"
        fallback = [
            "ร้านสะดวกซื้อ", "ธุรกิจสุขภาพ", "ธุรกิจออนไลน์", "บริการส่งของ",
            "ธุรกิจการศึกษา", "แฟรนไชส์อาหาร", "ร้านกาแฟสด", "ธุรกิจสินค้าแม่และเด็ก",
            "ธุรกิจแฟชั่น", "ธุรกิจไอที"
        ]
    elif month in [7, 8, 9]:
        quarter = "Q3"
        fallback = [
            "ธุรกิจเกษตร", "ธุรกิจขนส่ง", "บริการเดลิเวอรี่", "ร้านซ่อมอุปกรณ์อิเล็กทรอนิกส์",
            "ธุรกิจอสังหาริมทรัพย์", "ธุรกิจอาหารสุขภาพ", "ธุรกิจผลิตภัณฑ์ความงาม",
            "ร้านขายของทำมือ", "ธุรกิจคอร์สออนไลน์", "ธุรกิจแฟรนไชส์ร้านอาหาร"
        ]
    else:
        quarter = "Q4"
        fallback = [
            "ธุรกิจของขวัญและของตกแต่ง", "ธุรกิจเทศกาล", "ธุรกิจเครื่องประดับ",
            "ธุรกิจแฟชั่น", "ธุรกิจบริการซ่อมแซม", "ธุรกิจอีคอมเมิร์ซ",
            "ธุรกิจขายของออนไลน์", "ธุรกิจส่งอาหาร", "ธุรกิจร้านหนังสือ", "ธุรกิจสุขภาพ"
        ]

    return fallback, quarter
